        ...
        <header className="sticky top-0 z-40 h-16 bg-white/70 border-b border-gray-200/80">
            <div className="p-4 w-full max-w-7xl mx-auto flex items-center justify-between">
                ...
                <nav className="flex justify-center items-center gap-4" aria-label="primary navigation">
                    <button className="inline-flex items-center justify-center gap-2 text-sm text-gray-700 px-4 py-2 hover:text-[#00BFA6] transition-colors cursor-pointer">
                        <Search className="h-4 w-4" /> Search
                    </button>
                    <button
                        className="w-8 h-8 rounded-full overflow-hidden border-1 border-[#00BFA6]/50 shadow-sm hover:shadow-md transition"
                        aria-label="Profile"
                    >
                        {
                            user?.avatar ? (
